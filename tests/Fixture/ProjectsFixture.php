...
class ProjectsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'location' => ['type' => 'string', 'length' => 2048, 'null' => false, 'default' => null, 'precision' => null, 'comment' => null, 'fixed' => null, 'collate' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'projects_id_uindex' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'created' => '2018-08-16 22:43:03',
                'modified' => '2018-08-16 22:43:03',
