...
/**
 * FileFolderFiltersFixture
 *
 */
class FileFolderFiltersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'file_folder_filter' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'precision' => null, 'comment' => null, 'collate' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'created' => '2018-12-11 21:52:21',
                'modified' => '2018-12-11 21:52:21',
                'name' => 'Lorem ipsum dolor sit amet',
                'file_folder_filter' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.'
            ],
        ];
        parent::init();
    }
